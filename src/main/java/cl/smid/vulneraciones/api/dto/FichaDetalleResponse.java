...
@Schema(description = "Detalle de una Ficha Interna Reservada. Expone solo identificadores opacos.")
public record FichaDetalleResponse(
        ...
        @Schema(description = "Indica que relatos/descripciones fueron ocultados por falta de rol reservado.",
                example = "true")
        boolean reservadoOculto,
        EnriquecimientoResponse enriquecimiento,
        @Schema(description = "Vulneraciones registradas en la FIR.")
        List<VulneracionResponse> vulneraciones,
        @Schema(description = "Antecedentes reservados registrados en la FIR.")
        List<AntecedenteResponse> antecedentes,
        @Schema(description = "Historial de materialización y transiciones.")
